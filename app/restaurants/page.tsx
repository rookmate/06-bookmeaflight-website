...
export default function Restaurants() {
  ...
  const chapterData = {
    images: [
      ...
      { src: `${cloudinaryBaseURL}/v1737841791/cdl-soup.jpg`, alt: "CDL Soup" },
      ...
      { src: `${cloudinaryBaseURL}/v1737841790/spoon.jpg`, alt: "Spoon" },
      { src: `${cloudinaryBaseURL}/v1737841789/karater-table.jpg`, alt: "Karater Table" },
      { src: `${cloudinaryBaseURL}/v1737841789/cdl-wine.jpg`, alt: "CDL Wine" },
      { src: `${cloudinaryBaseURL}/v1737841789/da-pasta.jpg`, alt: "Da Pasta" },
      { src: `${cloudinaryBaseURL}/v1737841789/1894-sangines.jpg`, alt: "1894 Sangines" },
      { src: `${cloudinaryBaseURL}/v1737841788/lb-croissant.jpg`, alt: "LB Croissant" },
      { src: `${cloudinaryBaseURL}/v1737841788/bisque-drinks.jpg`, alt: "Bisque Drinks" },
      { src: `${cloudinaryBaseURL}/v1737841788/lb-salmon.jpg`, alt: "LB Salmon" },
      { src: `${cloudinaryBaseURL}/v1737841788/n-kinkali.jpg`, alt: "N Kinkali" },
      { src: `${cloudinaryBaseURL}/v1737841787/kiko-wine1.jpg`, alt: "Kiko Wine 1" },
      { src: `${cloudinaryBaseURL}/v1737841786/opus-drink.jpg`, alt: "Opus Drink" },
      ...
      { src: `${cloudinaryBaseURL}/v1737841785/c-pizza.jpg`, alt: "C Pizza" },
      { src: `${cloudinaryBaseURL}/v1737841784/ocf-brunch.jpg`, alt: "OCF Brunch" },
      { src: `${cloudinaryBaseURL}/v1737841784/sg-churros.jpg`, alt: "SG Churros" },
      ...
      { src: `${cloudinaryBaseURL}/v1737841784/sg-cutie.jpg`, alt: "SG Cutie" },
      { src: `${cloudinaryBaseURL}/v1737841783/ocf-fruit.jpg`, alt: "OCF Fruit" },
