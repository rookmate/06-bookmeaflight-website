  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <main className="flex-1">
        <section className="w-full h-[100vh] bg-[url('https://res.cloudinary.com/dnwbkkjpo/image/upload/v1718299505/ld-export-9dddc056-06132024_jlqaft.jpg')] bg-cover bg-center">
